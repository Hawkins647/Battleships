...
class Battleships:
    ...
    def __init__(self, root, background_colour, foreground_colour, grid_font):
        ...
        self.grid_button_a1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a1.grid(row=1, column=1)
        self.grid_button_a2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a2.grid(row=1, column=2)
        self.grid_button_a3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a3.grid(row=1, column=3)
        self.grid_button_a4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a4.grid(row=1, column=4)
        self.grid_button_a5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a5.grid(row=1, column=5)
        self.grid_button_a6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a6.grid(row=1, column=6)
        self.grid_button_a7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a7.grid(row=1, column=7)
        self.grid_button_a8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a8.grid(row=1, column=8)
        self.grid_button_a9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a9.grid(row=1, column=9)
        self.grid_button_a10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_a10.grid(row=1, column=10)

        self.grid_button_b1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b1.grid(row=2, column=1)
        self.grid_button_b2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b2.grid(row=2, column=2)
        self.grid_button_b3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b3.grid(row=2, column=3)
        self.grid_button_b4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b4.grid(row=2, column=4)
        self.grid_button_b5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b5.grid(row=2, column=5)
        self.grid_button_b6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b6.grid(row=2, column=6)
        self.grid_button_b7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b7.grid(row=2, column=7)
        self.grid_button_b8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b8.grid(row=2, column=8)
        self.grid_button_b9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b9.grid(row=2, column=9)
        self.grid_button_b10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_b10.grid(row=2, column=10)

        self.grid_button_c1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c1.grid(row=3, column=1)
        self.grid_button_c2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c2.grid(row=3, column=2)
        self.grid_button_c3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c3.grid(row=3, column=3)
        self.grid_button_c4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c4.grid(row=3,column=4)
        self.grid_button_c5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c5.grid(row=3, column=5)
        self.grid_button_c6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c6.grid(row=3, column=6)
        self.grid_button_c7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c7.grid(row=3, column=7)
        self.grid_button_c8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c8.grid(row=3, column=8)
        self.grid_button_c9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c9.grid(row=3, column=9)
        self.grid_button_c10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_c10.grid(row=3, column=10)

        self.grid_button_d1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d1.grid(row=4, column=1)
        self.grid_button_d2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d2.grid(row=4, column=2)
        self.grid_button_d3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d3.grid(row=4, column=3)
        self.grid_button_d4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d4.grid(row=4,column=4)
        self.grid_button_d5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d5.grid(row=4, column=5)
        self.grid_button_d6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d6.grid(row=4, column=6)
        self.grid_button_d7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d7.grid(row=4, column=7)
        self.grid_button_d8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d8.grid(row=4, column=8)
        self.grid_button_d9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d9.grid(row=4, column=9)
        self.grid_button_d10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_d10.grid(row=4, column=10)

        self.grid_button_e1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e1.grid(row=5, column=1)
        self.grid_button_e2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e2.grid(row=5, column=2)
        self.grid_button_e3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e3.grid(row=5, column=3)
        self.grid_button_e4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e4.grid(row=5,column=4)
        self.grid_button_e5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e5.grid(row=5, column=5)
        self.grid_button_e6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e6.grid(row=5, column=6)
        self.grid_button_e7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e7.grid(row=5, column=7)
        self.grid_button_e8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e8.grid(row=5, column=8)
        self.grid_button_e9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e9.grid(row=5, column=9)
        self.grid_button_e10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_e10.grid(row=5, column=10)

        self.grid_button_f1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f1.grid(row=6, column=1)
        self.grid_button_f2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f2.grid(row=6, column=2)
        self.grid_button_f3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f3.grid(row=6, column=3)
        self.grid_button_f4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f4.grid(row=6,column=4)
        self.grid_button_f5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f5.grid(row=6, column=5)
        self.grid_button_f6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f6.grid(row=6, column=6)
        self.grid_button_f7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f7.grid(row=6, column=7)
        self.grid_button_f8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f8.grid(row=6, column=8)
        self.grid_button_f9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f9.grid(row=6, column=9)
        self.grid_button_f10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_f10.grid(row=6, column=10)

        self.grid_button_g1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g1.grid(row=7, column=1)
        self.grid_button_g2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g2.grid(row=7, column=2)
        self.grid_button_g3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g3.grid(row=7, column=3)
        self.grid_button_g4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g4.grid(row=7,column=4)
        self.grid_button_g5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g5.grid(row=7, column=5)
        self.grid_button_g6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g6.grid(row=7, column=6)
        self.grid_button_g7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g7.grid(row=7, column=7)
        self.grid_button_g8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g8.grid(row=7, column=8)
        self.grid_button_g9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g9.grid(row=7, column=9)
        self.grid_button_g10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_g10.grid(row=7, column=10)

        self.grid_button_h1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h1.grid(row=8, column=1)
        self.grid_button_h2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h2.grid(row=8, column=2)
        self.grid_button_h3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h3.grid(row=8, column=3)
        self.grid_button_h4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h4.grid(row=8,column=4)
        self.grid_button_h5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h5.grid(row=8, column=5)
        self.grid_button_h6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h6.grid(row=8, column=6)
        self.grid_button_h7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h7.grid(row=8, column=7)
        self.grid_button_h8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h8.grid(row=8, column=8)
        self.grid_button_h9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h9.grid(row=8, column=9)
        self.grid_button_h10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_h10.grid(row=8, column=10)

        self.grid_button_i1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i1.grid(row=9, column=1)
        self.grid_button_i2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i2.grid(row=9, column=2)
        self.grid_button_i3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i3.grid(row=9, column=3)
        self.grid_button_i4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i4.grid(row=9,column=4)
        self.grid_button_i5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i5.grid(row=9, column=5)
        self.grid_button_i6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i6.grid(row=9, column=6)
        self.grid_button_i7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i7.grid(row=9, column=7)
        self.grid_button_i8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i8.grid(row=9, column=8)
        self.grid_button_i9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i9.grid(row=9, column=9)
        self.grid_button_i10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_i10.grid(row=9, column=10)

        self.grid_button_j1 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_j1.grid(row=10, column=1)
        self.grid_button_j2 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_j2.grid(row=10, column=2)
        self.grid_button_j3 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_j3.grid(row=10, column=3)
        self.grid_button_j4 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_j4.grid(row=10,column=4)
        self.grid_button_j5 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_j5.grid(row=10, column=5)
        self.grid_button_j6 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_j6.grid(row=10, column=6)
        self.grid_button_j7 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_j7.grid(row=10, column=7)
        self.grid_button_j8 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_j8.grid(row=10, column=8)
        self.grid_button_j9 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
        self.grid_button_j9.grid(row=10, column=9)
        self.grid_button_j10 = tk.Button(grid_frame, text="", bg=self.background_colour, font=self.grid_font, width=2)
